...
export const stylists: Stylist[] = [
  ...
  },
  {
    ...
    bio: "Anna is a passionate new hairstylist with a big heart for making people feel comfortable, confident, and truly seen. She creates a welcoming, judgment-free space where clients can relax, be themselves, and leave feeling even more beautiful than when they walked in. Blonding is one of her favorite things to do behind the chair—she loves the process of creating that perfect, glowing blonde that lights someone up from the inside out. Always eager to learn and grow, both in her craft and as a person, Anna is dedicated to building real connections and helping every client feel their absolute best.",
    specialties: ["Blonding and Brightening", "Comfort Centered Styling", "Dimensional Color"],
    bookingUrl: "https://heirloomstudiomke.glossgenius.com/",
    instagramUrl: "https://www.instagram.com/hairbyannavg?igsh=aGd6OWVqaWY0Njlh"
  },
    {
    name: "Hanna",
    title: "Stylist",
